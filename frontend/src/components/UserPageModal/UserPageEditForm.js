...
function EditProfileForm({ user }) {
    ...
    // const currAlbums = useSelector(state => state.albums);
    // const currPhotostream = useSelector(state => state.photostream);
    const viewedUser = useSelector(state => state.user);

    // const [description, setDescription] = useState(viewedUser.profile.description);
